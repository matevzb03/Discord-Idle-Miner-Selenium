...
import time
#open disocrd
chrome_path = r"C:\Users\GlitchBoii\Downloads\chromedriver_win32\chromedriver.exe"
driver = webdriver.Chrome(chrome_path)
driver.get("https://discord.com/login")
time.sleep(2)
#input email
driver.find_element_by_xpath("""//*[@id="app-mount"]/div[2]/div/div[2]/div/div/form/div/div/div[1]/div[3]/div[1]/div/input""").send_keys("minecraftslo2005@gmail.com")
time.sleep(2)
#input password
driver.find_element_by_xpath("""//*[@id="app-mount"]/div[2]/div/div[2]/div/div/form/div/div/div[1]/div[3]/div[2]/div/input""").send_keys("Nigga1234!")
time.sleep(2)
#login click
